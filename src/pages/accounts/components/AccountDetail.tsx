...
import { v1AccountsRetrieveOptions, v1AccountsPaymentsListOptions } from '../../../client/@tanstack/react-query.gen';
...
import { exportAccountToExcel } from '../../../utils/excelExport';
                ...
                <MenuItems className="absolute right-0 mt-2 w-48 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-black/5 focus:outline-none z-50 overflow-hidden">
                  <div className="py-1">
                    <MenuItem>
                      {({ focus }) => (
                        <button
                          onClick={() => window.open(`/print/account/${accountId}?type=factura`, '_blank')}
                    ...
                    <MenuItem>
                      {({ focus }) => (
                        <button
                          onClick={() => window.open(`/print/account/${accountId}?type=nota_entrega`, '_blank')}
                          className={cn(focus ? 'bg-gray-50' : '', 'flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100')}
                        >
                          Nota de Recepción
                        </button>
